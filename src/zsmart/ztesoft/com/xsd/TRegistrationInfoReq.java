...
/**
 *  TRegistrationInfoReq bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TRegistrationInfoReq implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = tRegistrationInfoReq
     ...
     * field for Wallet_no
     */
    protected java.lang.String localWallet_no;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localWallet_noTracker = false;
    ...
    public boolean isWallet_noSpecified() {
        return localWallet_noTracker;
    }
     ...
     */
    public java.lang.String getWallet_no() {
        return localWallet_no;
    }

    /**
     * Auto generated setter method
     * @param param Wallet_no
     */
    public void setWallet_no(java.lang.String param) {
        localWallet_noTracker = param != null;

        this.localWallet_no = param;
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":tRegistrationInfoReq", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "tRegistrationInfoReq", xmlWriter);
            }
        }

        if (localWallet_noTracker) {
            namespace = "";
            writeStartElement(null, namespace, "wallet_no", xmlWriter);

            if (localWallet_no == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "wallet_no cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localWallet_no);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localWallet_noTracker) {
            elementList.add(new javax.xml.namespace.QName("", "wallet_no"));
    ...
    public static class Factory {
         ...
         */
        public static TRegistrationInfoReq parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TRegistrationInfoReq object = new TRegistrationInfoReq();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"tRegistrationInfoReq".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TRegistrationInfoReq) zsmart.ztesoft.com.xsd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "wallet_no").equals(
                            reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "wallet_no" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setWallet_no(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
