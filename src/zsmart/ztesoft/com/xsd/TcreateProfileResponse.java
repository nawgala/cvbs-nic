...
/**
 *  TcreateProfileResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TcreateProfileResponse implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = tcreateProfileResponse
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":tcreateProfileResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "tcreateProfileResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TcreateProfileResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TcreateProfileResponse object = new TcreateProfileResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"tcreateProfileResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TcreateProfileResponse) zsmart.ztesoft.com.xsd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
