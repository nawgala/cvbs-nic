...
/**
 *  TgetDetails bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TgetDetails implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":tgetDetails", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "tgetDetails", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TgetDetails parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            TgetDetails object = new TgetDetails();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"tgetDetails".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TgetDetails) zsmart.ztesoft.com.xsd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
