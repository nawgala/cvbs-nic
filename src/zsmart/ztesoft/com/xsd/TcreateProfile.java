...
/**
 *  TcreateProfile bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TcreateProfile implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for WalletNo
     */
    protected java.lang.String localWalletNo;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localWalletNoTracker = false;
    ...
    public boolean isWalletNoSpecified() {
        return localWalletNoTracker;
    }
     ...
     */
    public java.lang.String getWalletNo() {
        return localWalletNo;
    }

    /**
     * Auto generated setter method
     * @param param WalletNo
     */
    public void setWalletNo(java.lang.String param) {
        localWalletNoTracker = param != null;

        this.localWalletNo = param;
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":tcreateProfile", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "tcreateProfile", xmlWriter);
            }
        }

        if (localWalletNoTracker) {
            namespace = "";
            writeStartElement(null, namespace, "walletNo", xmlWriter);

            if (localWalletNo == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "walletNo cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localWalletNo);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localWalletNoTracker) {
            elementList.add(new javax.xml.namespace.QName("", "walletNo"));
    ...
    public static class Factory {
         ...
         */
        public static TcreateProfile parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TcreateProfile object = new TcreateProfile();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"tcreateProfile".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TcreateProfile) zsmart.ztesoft.com.xsd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "walletNo").equals(
                            reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "walletNo" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setWalletNo(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
