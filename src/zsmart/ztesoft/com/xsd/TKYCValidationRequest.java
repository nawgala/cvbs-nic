...
/**
 *  TKYCValidationRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TKYCValidationRequest implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = tKYCValidationRequest
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":tKYCValidationRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "tKYCValidationRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TKYCValidationRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TKYCValidationRequest object = new TKYCValidationRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"tKYCValidationRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TKYCValidationRequest) zsmart.ztesoft.com.xsd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
