...
/**
 *  TRegistrationInfoRsp bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TRegistrationInfoRsp implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = tRegistrationInfoRsp
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":tRegistrationInfoRsp", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "tRegistrationInfoRsp", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TRegistrationInfoRsp parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TRegistrationInfoRsp object = new TRegistrationInfoRsp();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"tRegistrationInfoRsp".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TRegistrationInfoRsp) zsmart.ztesoft.com.xsd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
