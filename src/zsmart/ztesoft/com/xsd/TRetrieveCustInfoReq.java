...
/**
 *  TRetrieveCustInfoReq bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TRetrieveCustInfoReq implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = tRetrieveCustInfoReq
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":tRetrieveCustInfoReq", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "tRetrieveCustInfoReq", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TRetrieveCustInfoReq parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TRetrieveCustInfoReq object = new TRetrieveCustInfoReq();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"tRetrieveCustInfoReq".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TRetrieveCustInfoReq) zsmart.ztesoft.com.xsd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
