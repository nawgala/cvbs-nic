...
/**
 *  TKYCValidationResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TKYCValidationResponse implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = tKYCValidationResponse
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":tKYCValidationResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "tKYCValidationResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TKYCValidationResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TKYCValidationResponse object = new TKYCValidationResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"tKYCValidationResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TKYCValidationResponse) zsmart.ztesoft.com.xsd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
